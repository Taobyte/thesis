...
JOB="python main.py --multirun hydra/launcher=submitit_slurm dataset=dalia,wildppg,ieee lbw=b pw=b,c model=linear,hlinear,kalmanfilter,xgboost,hxgboost normalization=none use_wandb=True tune=False experiment=endo_exo folds=fold_0,fold_1,fold_2"
