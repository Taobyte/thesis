...
sbatch --job-name="$DALIA_RUNS_%j.out" -o "$DALIA_RUNS_%j.err" --time="$TIME" --wrap="$JOB"
...
sbatch --job-name="$WILDPPG_RUNS_%j.out" -o "$WILDPPG_RUNS_%j.err" --time="$TIME" --wrap="$JOB"
...
sbatch --job-name="$IEEE_RUNS_%j.out" -o "$IEEE_RUNS_%j.err" --time="$TIME" --wrap="$JOB"
