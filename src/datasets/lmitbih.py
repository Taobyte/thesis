...
from src.datasets.mitbih import MITBIHDatamodule, MITBIHDataset


class LMITBIHDataset(MITBIHDataset):
    def __init__(
        self,
        flag: str = "train",
...
class LMITBIHDatamodule(MITBIHDatamodule):
    def __init__(
        self,
        participant: int = 1,
